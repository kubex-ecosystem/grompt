...
// This file consolidates the entire application's source code into a single string.
// It's a necessary utility for the "Virtuous Meta-Recursion" feature, allowing
// the application to send its own code to the AI for refactoring.

export const getFullSourceCode = (): string => {
  return `
...
<html lang="en" class="dark">
  <head>
    ...
    <title>Grompt - AI Prompt Crafter</title>
    ...
    <style>
      ...
      .glow-border {
        box-shadow: 0 0 2px 0px #00e5ff, 0 0 5px 0px #00e5ff, 0 0 10px 0px #00e5ff;
      }
    </style>
    <script>
      tailwind.config = {
        ...
        theme: {
          extend: {
            ...
            colors: {
              ...
              secondary: {
                DEFAULT: '#2a0e4a', // dark purple
                hover: '#3c146b',
                foreground: '#e0cffc'
              },
              accent: {
                DEFAULT: '#39d353', // green
                hover: '#5cf073',
                foreground: '#010409'
              },
              muted: {
  ...
  <script type="importmap">
{
  "imports": {
    ...
    "lucide-react": "https://aistudiocdn.com/lucide-react@^0.543.0",
...
import { Plus, Trash2, Wand2, Clipboard, Check, RefreshCw, Download, History, Search, Lightbulb, X, BrainCircuit, Copy } from 'lucide-react';
        ...
        <main className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <section className="bg-card border border-border rounded-lg p-6 backdrop-blur-sm flex flex-col gap-6">
              ...
              <div className="flex gap-2">
                  ...
                  />
                  <button onClick={handleAddIdea} disabled={!currentIdea.trim()} className="p-3 bg-secondary hover:bg-secondary-hover rounded-md disabled:opacity-50 disabled:cursor-not-allowed transition-colors">
        ...
        <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-card border border-border rounded-lg shadow-neon-cyan w-full max-w-4xl h-[90vh] flex flex-col">
            <header className="flex items-center justify-between p-4 border-b border-border">
              ...
              <button onClick={closeEvolveModal} className="p-1 text-muted-foreground hover:text-primary"><X className="w-5 h-5" /></button>
            </header>
...
// --- END OF FILE: services/dbService.ts ---


// --- START OF FILE: components/ui/Loader.tsx ---
