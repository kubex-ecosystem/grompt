...
[![Build Status](https://img.shields.io/github/actions/workflow/status/rafa-mori/grompt/release.yml?branch=main)](https://github.com/rafa-mori/grompt/actions/workflows/release.yml)
